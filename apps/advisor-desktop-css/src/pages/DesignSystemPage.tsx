    ...
    <React.Fragment>
      ...
      <div className="p-3">
        <div className="card max-w-800 p-3">
          ...
          <h2 className="h2 mt-1">h2. Heading 1</h2>
          <h3 className="h3 mt-1">h3. Heading 1</h3>
          <h4 className="h4 mt-1">h4. Heading 1</h4>
          <h5 className="h5 mt-1">h5. Heading 1</h5>
          <h6 className="h6 mt-1">h6. Heading 1</h6>
          <h6 className="h6sm mt-1">h6sm. Heading 1</h6>
          <h6 className="h6xs mt-1">h6xs. Heading 1</h6>
